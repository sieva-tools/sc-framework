...
```bash
curl -fsSL https://raw.githubusercontent.com/sieva-tools/sc-framework/main/install.sh | bash
```
...
```bash
git clone https://github.com/sieva-tools/sc-framework.git ~/.claude/skills/sc
